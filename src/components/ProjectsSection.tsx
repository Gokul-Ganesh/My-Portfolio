...
const PROJECTS: ProjectData[] = [
    {
        ...
        category: 'Personal',
        name: 'Seoul',
        liveUrl: 'https://seoul.n18naveen.workers.dev/',
        col1Image1: '/Seoul.png',
        col1Image2: '/Seoul1.png',
        col2Image: '/Seoul2.png',
      },
  {
      number: '02',
      category: 'Personal',
      name: 'Everlasting Echoes',
      liveUrl: 'https://everlasting-echoes.n18naveen.workers.dev/',
      col1Image1: '/EE.png',
      col1Image2: '/EE1.png',
      col2Image: '/EE2.png',
    },
  {
    ...
    name: 'OmniZentrix',
    liveUrl: 'https://omnizentrix.n18naveen.workers.dev/',
    col1Image1: 'OZ.png',
    col1Image2: 'OZ1.png',
    col2Image: 'OZ2.png',
  },
